...
export default async function Page({
  ...
  const tab = sp.tab ? String(sp.tab) : "affiliates";

  return (
    <div className="space-y-6">
      <div>
        <p className="text-sm font-medium text-accent">Business</p>
        <h1 className="mt-2 text-3xl font-semibold tracking-tight">Affiliates & referrals</h1>
      ...
      <Card className="bg-[#0D1320]">
        <CardHeader>
          ...
          <div className="mt-1 text-sm text-muted">
            Affiliate applications, referral funnel, payout approvals.
          </div>
        </CardHeader>
        <CardContent>
